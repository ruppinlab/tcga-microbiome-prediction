...
make_analysis_plots <- function(model_scores, clinical_model_scores) {
...
make_analysis_plots(cnet_model_scores, cox_clinical_model_scores)
...
make_analysis_plots(rfe_model_scores, svm_clinical_model_scores)
